...
echo "export BUN_INSTALL=/home/sourcegraph/.bun" | tee -a "$HOME/.bashrc"
echo "export PATH=/home/sourcegraph/.bun/bin:/home/sourcegraph/.bun/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin
" | tee -a "$HOME/.bashrc"
